...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">ai-directory-fe documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/Business.html" data-type="entity-link" >Business</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/TestWebService.html" data-type="entity-link" >TestWebService</a>
                            </li>
                        </ul>
                    </li>
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="injectables-links"' : 'id="xs-injectables-links"' }>
                                ...
                                <li class="link">
                                    <a href="injectables/BusinessData.html" data-type="entity-link" >BusinessData</a>
                                </li>
                                <li class="link">
